...
The tests described in the following table were performed on __December 12, 2024__ to test whether the interface between gromacs-vanilla and the master version of PLUMED is working correctly.
...
| MD code potential energy passed correctly | [![tested on master](https://img.shields.io/badge/master-fail%201821435596%25-red.svg)](energy_master.html) |
...
| PLUMED contribution to virial due to force on potential energy passed correctly | [![tested on master](https://img.shields.io/badge/master-fail%2043%25-red.svg)](engvir_master.html) |
