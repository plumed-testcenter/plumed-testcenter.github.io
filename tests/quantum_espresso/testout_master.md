...
The tests described in the following table were performed on __June 27, 2024__ to test whether the interface between quantum_espresso and the master version of PLUMED is working correctly.
...
| PLUMED forces on potential energy passed correctly | [![tested on master](https://img.shields.io/badge/master-fail%2044%25-red.svg)](engforce_master.html) |
