...
The tests described in the following tables were performed on __June 15, 2025__ to test whether the interface between lammps and the master version of PLUMED is working correctly.
