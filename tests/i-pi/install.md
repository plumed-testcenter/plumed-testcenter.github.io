...
To compile i-pi and PLUMED the following bash script was used.  i-pi was statically linked with the v2.10 of PLUMED. In a separate build, the master version of PLUMED was linked to i-pi as a runtime library. 
