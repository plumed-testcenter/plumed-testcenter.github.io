...
The tests described in the following tables were performed on __May 25, 2025__ to test whether the interface between gromacs and the master version of PLUMED is working correctly.
...
| PLUMED forces on potential energy passed correctly | [![tested on master](https://img.shields.io/badge/master-fail%20728%25-red.svg)](engforces_master.html) |
| PLUMED contribution to virial due to force on potential energy passed correctly | [![tested on master](https://img.shields.io/badge/master-fail%201196%25-red.svg)](engvir_master.html) |
