...
To compile lammps and PLUMED the following bash script was used.  lammps was statically linked with the v2.10 of PLUMED. In a separate build, the master version of PLUMED was linked to lammps as a runtime library. 
