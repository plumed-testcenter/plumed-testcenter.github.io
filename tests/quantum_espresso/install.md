...
To compile quantum_espresso and PLUMED the following bash script was used.  quantum_espresso was statically linked with the v2.10 of PLUMED. In a separate build, the master version of PLUMED was linked to quantum_espresso as a runtime library. 
