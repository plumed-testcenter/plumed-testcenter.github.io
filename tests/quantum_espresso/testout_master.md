...
The tests described in the following table were performed on __February 19, 2025__ to test whether the interface between quantum_espresso and the master version of PLUMED is working correctly.
...
| PLUMED forces on potential energy passed correctly | [![tested on master](https://img.shields.io/badge/master-fail%201%25-green.svg)](engforces_master.html) |
