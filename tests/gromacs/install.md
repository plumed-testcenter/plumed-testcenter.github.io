...
To compile gromacs and PLUMED the following bash script was used.  gromacs was statically linked with the v2.10 of PLUMED. In a separate build, the master version of PLUMED was linked to gromacs as a runtime library. 
