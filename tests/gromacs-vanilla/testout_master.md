...
The tests described in the following tables were performed on __November 16, 2025__ to test whether the interface between gromacs-vanilla and the master version of PLUMED is working correctly.
...
| Description of test | Status | 
|:--------------------|:------:| 
| PLUMED virial passed correctly | [![tested on master](https://img.shields.io/badge/master-fail%205%25-yellow.svg)](virial_master.html) |
