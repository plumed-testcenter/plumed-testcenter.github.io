...
The tests described in the following table were performed on __April 14, 2023__ to test whether the interface between lammps and the master version of PLUMED is working correctly.
...
| MD code charges passed correctly | [![tested on master](https://img.shields.io/badge/master-passing-green.svg)](charge_master.html) | 
