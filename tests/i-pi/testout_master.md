...
The tests described in the following tables were performed on __May 25, 2025__ to test whether the interface between i-pi and the master version of PLUMED is working correctly.
...
| MD code cell vectors passed correctly | [![tested on master](https://img.shields.io/badge/master-fail%2011901%25-red.svg)](cell_master.html) |
...
| Description of test | Status | 
|:--------------------|:------:| 
| PLUMED virial passed correctly | [![tested on master](https://img.shields.io/badge/master-fail%20343%25-red.svg)](virial_master.html) |
...
| PLUMED contribution to virial due to force on potential energy passed correctly | [![tested on master](https://img.shields.io/badge/master-fail%20471%25-red.svg)](engvir_master.html) |
