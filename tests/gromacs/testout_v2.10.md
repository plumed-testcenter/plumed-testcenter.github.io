...
The tests described in the following table were performed on __December 06, 2024__ to test whether the interface between gromacs and the v2.10 version of PLUMED is working correctly.
...
| PLUMED forces on potential energy passed correctly | [![tested on v2.10](https://img.shields.io/badge/v2.10-fail%201982%25-red.svg)](engforces_v2.10.html) |
| PLUMED contribution to virial due to force on potential energy passed correctly | [![tested on v2.10](https://img.shields.io/badge/v2.10-fail%20940%25-red.svg)](engvir_v2.10.html) |
