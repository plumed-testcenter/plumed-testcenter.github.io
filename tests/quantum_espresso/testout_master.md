...
The tests described in the following tables were performed on __August 24, 2025__ to test whether the interface between quantum_espresso and the master version of PLUMED is working correctly.
...
| PLUMED forces on potential energy passed correctly | [![tested on master](https://img.shields.io/badge/master-fail%2021%25-red.svg)](engforces_master.html) |
