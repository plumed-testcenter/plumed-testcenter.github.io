...
The tests described in the following tables were performed on __August 11, 2025__ to test whether the interface between quantum_espresso and the v2.10 version of PLUMED is working correctly.
...
| PLUMED forces on potential energy passed correctly | [![tested on v2.10](https://img.shields.io/badge/v2.10-fail%2078%25-red.svg)](engforces_v2.10.html) |
