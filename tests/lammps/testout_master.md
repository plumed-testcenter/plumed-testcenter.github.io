...
The tests described in the following table were performed on __June 27, 2024__ to test whether the interface between lammps and the master version of PLUMED is working correctly.
...
| PLUMED forces passed correctly | [![tested on master](https://img.shields.io/badge/master-fail%201%25-green.svg)](forces_master.html) |
...
| PLUMED forces on potential energy passed correctly | [![tested on master](https://img.shields.io/badge/master-fail%201300%25-red.svg)](engforce_master.html) |
| PLUMED contribution to virial due to force on potential energy passed correctly | [![tested on master](https://img.shields.io/badge/master-fail%20862%25-red.svg)](engvir_master.html) |
