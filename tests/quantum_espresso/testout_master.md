...
The tests described in the following tables were performed on __November 23, 2025__ to test whether the interface between quantum_espresso and the master version of PLUMED is working correctly.
...
| PLUMED forces on potential energy passed correctly | [![tested on master](https://img.shields.io/badge/master-fail%2011%25-yellow.svg)](engforces_master.html) |
