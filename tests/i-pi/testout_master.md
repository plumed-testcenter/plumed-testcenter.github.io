...
The tests described in the following table were performed on __December 09, 2024__ to test whether the interface between i-pi and the master version of PLUMED is working correctly.
...
| PLUMED virial passed correctly | [![tested on master](https://img.shields.io/badge/master-fail%2082%25-red.svg)](virial_master.html) |
