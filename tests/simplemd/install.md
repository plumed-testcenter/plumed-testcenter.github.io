...
To compile simplemd and PLUMED the following bash script was used.  simplemd was statically linked with the v2.9 of PLUMED. In a separate build, the master version of PLUMED was linked to simplemd as a runtime library. 
